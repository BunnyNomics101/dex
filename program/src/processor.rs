...
mod bunny_token {
    ...
    declare_id!("7zhbkbKpGaUsJW7AD4yyAfGGoy53Xx2H3Ai5BKcwGKHw");
}
// mod msrm_token {
//     use solana_program::declare_id;
...
// }
pub static BUNNY_MINT: Pubkey = bunny_token::ID;
...
pub mod fee_defaults {
    ...
    #[allow(missing_docs)]
    pub const DEFAULT_FEE_TIER_THRESHOLDS: [u64; 5] = [1, 10, 50, 100, 250];
    #[allow(missing_docs)]
    pub const DEFAULT_FEE_TIER_TAKER_BPS_RATES: [u64; 6] = [22, 20, 18, 16, 14, 12];
    #[allow(missing_docs)]
    pub const DEFAULT_FEE_TIER_MAKER_BPS_REBATES: [u64; 6] = [3, 3, 3, 3, 3, 3];
}
